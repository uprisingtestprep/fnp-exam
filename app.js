/* FNP Exam Simulator — Application Logic */

const ACCESS_CODE  = "FNP9000";
const EXAM_SECONDS = 12600;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "fnp_exam_state_v1";
const SIM_Q_COUNT  = 300;

const DOMAIN_LABELS = {
  primary_care_medicine: "Primary Care Medicine",
  specialty_systems: "Specialty Systems",
...
function showResults() {
  ...
  domDiv.innerHTML = "";
  Object.entries(domainStats).forEach(([domKey, s]) => {
    const dom = domainLabel(domKey);
